...
Section "Журнал термометрии" SEC01
  ...
  File "build\ThermometryLog\lib\lib2to3\btm_matcher.pyc"
  File "build\ThermometryLog\lib\lib2to3\btm_utils.pyc"
  File "build\ThermometryLog\lib\lib2to3\fixer_util.pyc"
  File "build\ThermometryLog\lib\lib2to3\Grammar.txt"
  File "build\ThermometryLog\lib\lib2to3\Grammar3.8.3.final.0.pickle"
  File "build\ThermometryLog\lib\lib2to3\patcomp.pyc"
  File "build\ThermometryLog\lib\lib2to3\PatternGrammar.txt"
  File "build\ThermometryLog\lib\lib2to3\PatternGrammar3.8.3.final.0.pickle"
  SetOutPath "$INSTDIR\lib\lib2to3\pgen2"
  File "build\ThermometryLog\lib\lib2to3\pgen2\driver.pyc"
  File "build\ThermometryLog\lib\lib2to3\pgen2\grammar.pyc"
  File "build\ThermometryLog\lib\lib2to3\pgen2\literals.pyc"
  File "build\ThermometryLog\lib\lib2to3\pgen2\parse.pyc"
  File "build\ThermometryLog\lib\lib2to3\pgen2\pgen.pyc"
  File "build\ThermometryLog\lib\lib2to3\pgen2\token.pyc"
  File "build\ThermometryLog\lib\lib2to3\pgen2\tokenize.pyc"
  File "build\ThermometryLog\lib\lib2to3\pgen2\__init__.pyc"
  SetOutPath "$INSTDIR\lib\lib2to3"
  File "build\ThermometryLog\lib\lib2to3\pygram.pyc"
  File "build\ThermometryLog\lib\lib2to3\pytree.pyc"
  File "build\ThermometryLog\lib\lib2to3\refactor.pyc"
  SetOutPath "$INSTDIR\lib\lib2to3\tests\data"
  File "build\ThermometryLog\lib\lib2to3\tests\data\README"
  SetOutPath "$INSTDIR\lib\lib2to3"
  File "build\ThermometryLog\lib\lib2to3\__init__.pyc"
  SetOutPath "$INSTDIR\lib"
  ...
  File "build\ThermometryLog\lib\pkg_resources\extern\__init__.pyc"
  SetOutPath "$INSTDIR\lib\pkg_resources\_vendor"
  File "build\ThermometryLog\lib\pkg_resources\_vendor\appdirs.pyc"
  SetOutPath "$INSTDIR\lib\pkg_resources\_vendor\packaging"
  File "build\ThermometryLog\lib\pkg_resources\_vendor\packaging\markers.pyc"
  File "build\ThermometryLog\lib\pkg_resources\_vendor\packaging\requirements.pyc"
  File "build\ThermometryLog\lib\pkg_resources\_vendor\packaging\specifiers.pyc"
  File "build\ThermometryLog\lib\pkg_resources\_vendor\packaging\tags.pyc"
  File "build\ThermometryLog\lib\pkg_resources\_vendor\packaging\utils.pyc"
  File "build\ThermometryLog\lib\pkg_resources\_vendor\packaging\version.pyc"
  File "build\ThermometryLog\lib\pkg_resources\_vendor\packaging\_compat.pyc"
  File "build\ThermometryLog\lib\pkg_resources\_vendor\packaging\_structures.pyc"
  File "build\ThermometryLog\lib\pkg_resources\_vendor\packaging\_typing.pyc"
  File "build\ThermometryLog\lib\pkg_resources\_vendor\packaging\__about__.pyc"
  File "build\ThermometryLog\lib\pkg_resources\_vendor\packaging\__init__.pyc"
  SetOutPath "$INSTDIR\lib\pkg_resources\_vendor"
  File "build\ThermometryLog\lib\pkg_resources\_vendor\pyparsing.pyc"
  File "build\ThermometryLog\lib\pkg_resources\_vendor\__init__.pyc"
  SetOutPath "$INSTDIR\lib\pkg_resources"
  File "build\ThermometryLog\lib\pkg_resources\__init__.pyc"
  SetOutPath "$INSTDIR\lib"
  ...
  File "C:\Users\Fil\AppData\Local\ThermometryLog\database.sqlite"
  File "C:\Users\Fil\AppData\Local\ThermometryLog\logs.log"
SectionEnd
...
!insertmacro MUI_FUNCTION_DESCRIPTION_BEGIN
  !insertmacro MUI_DESCRIPTION_TEXT ${SEC01} "Основное приложение"
...
Section Uninstall
  ...
  Delete "$INSTDIR\lib\lib2to3\PatternGrammar3.8.3.final.0.pickle"
  Delete "$INSTDIR\lib\lib2to3\PatternGrammar.txt"
  Delete "$INSTDIR\lib\lib2to3\patcomp.pyc"
  Delete "$INSTDIR\lib\lib2to3\Grammar3.8.3.final.0.pickle"
