...
class API(Sqlite3):
    ...
    def filter(self, table_name: str, table_fields: list = None, **where):
        """
    ...
    def insert(self, table_name: str, need_commit=True, **fields) -> str:
        """
    ...
    def add_field(
        self, table_name: str, field_name: str, field_type: str, start_value
    ) -> str:
        """
